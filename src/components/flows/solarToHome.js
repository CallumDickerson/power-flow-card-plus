...
exports.flowSolarToHome = void 0;
...
var flowSolarToHome = function (config, _a) {
    var _b;
    var battery = _a.battery, grid = _a.grid, individual = _a.individual, solar = _a.solar, newDur = _a.newDur;
    return solar.has && (0, showLine_1.showLine)(config, solar.state.toHome || 0) && !((_b = config.entities.home) === null || _b === void 0 ? void 0 : _b.hide)
        ...
        }), (0, styleLine_1.styleLine)(solar.state.toHome || 0, config), battery.has ? 55 : 53, grid.has ? 15 : 17, battery.has ? "30 10,30 30,30" : "35 10,35 30,35", (0, checkShouldShowDots_1.checkShouldShowDots)(config) && solar.state.toHome
            ? (0, lit_1.svg)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<circle\n                        r=\"1\"\n                        class=\"solar\"\n                        vector-effect=\"non-scaling-stroke\"\n                      >\n                        <animateMotion\n                          dur=\"", "s\"\n                          repeatCount=\"indefinite\"\n                          calcMode=\"linear\"\n                        >\n                          <mpath xlink:href=\"#solar\" />\n                        </animateMotion>\n                      </circle>"], ["<circle\n                        r=\"1\"\n                        class=\"solar\"\n                        vector-effect=\"non-scaling-stroke\"\n                      >\n                        <animateMotion\n                          dur=\"", "s\"\n                          repeatCount=\"indefinite\"\n                          calcMode=\"linear\"\n                        >\n                          <mpath xlink:href=\"#solar\" />\n                        </animateMotion>\n                      </circle>"])), newDur.solarToHome) : "") : "";
};
exports.flowSolarToHome = flowSolarToHome;

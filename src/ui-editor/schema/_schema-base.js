...
exports.secondaryInfoSchema = exports.tapActionSchema = exports.customColorsSchema = void 0;
exports.getEntityCombinedSelectionSchema = getEntityCombinedSelectionSchema;
exports.getEntitySeparatedSelectionSchema = getEntitySeparatedSelectionSchema;
exports.getBaseMainConfigSchema = getBaseMainConfigSchema;
var localize_1 = require("@/localize/localize");
function getEntityCombinedSelectionSchema() {
    return {
        type: "expandable",
        title: (0, localize_1.default)("editor.combined"),
        schema: [
            {
                name: "entity",
                selector: { entity: {} },
...
function getEntitySeparatedSelectionSchema() {
    return {
        type: "expandable",
        title: (0, localize_1.default)("editor.separated"),
        name: "entity",
        schema: [
            {
                name: "consumption",
...
exports.customColorsSchema = {
    name: "color",
    title: (0, localize_1.default)("editor.custom_colors"),
    type: "expandable",
    schema: [
        {
            type: "grid",
...
exports.secondaryInfoSchema = [
    ...
    },
    {
        ...
        name: "",
        type: "expandable",
        schema: exports.tapActionSchema,
    },
];
var batteryOrGridMainConfigSchema = [
    {
        name: "color_icon",
        label: "Color of Icon",
        selector: {
...
function getBaseMainConfigSchema(field) {
    var _a;
    var result = {
        type: "grid",
        column_min_width: "200px",
    ...
    if (field === "battery" || field === "grid") {
        (_a = result.schema).push.apply(_a, batteryOrGridMainConfigSchema);
    }
    return result;
}
